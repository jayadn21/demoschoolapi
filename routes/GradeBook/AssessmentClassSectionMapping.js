...
router.post('/setAssessmentClassSectionMapping', function (req, res) {
    ...
    try {
        ...
        dbConn.connect().then(function () {
            ...
            request.input('CalculateSecSubjMarksAs', sql.Int, parseInt(CalculateSecSubjMarksAs, 10));
...
*/
router.post('/getAssessmentClassSectionMappingByAcademicYearClassAssessment', function (req, res) {
    let AcademicYearId = req.body.AcademicYearId;
    let ClassSectionMediumId = req.body.ClassSectionMediumId;
    let AssessmentId = req.body.AssessmentId;
    try {
        ...
        dbConn.connect().then(function () {
            ...
            request.execute("AssessmentClassSectionMapping_selectByAcademicYearClassAssessment").then(function (results) {
                console.log(results);
