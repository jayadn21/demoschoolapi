...
router.post('/getAssessments', function (req, res) {

    try {
        var dbConn = new sql.ConnectionPool(localconfig);
        dbConn.connect().then(function () {
            var request = new sql.Request(dbConn);
            request.execute("Assessment_selectAll").then(function (results) {
                console.log(results);
...
router.post('/getAssessment', function (req, res) {
    ...
    try {
        ...
        dbConn.connect().then(function () {
            ...
            request.execute("Assessment_selectById").then(function (results) {
                console.log(results);
...
*/
router.post('/setAssessment', function (req, res) {
    let Id = req.body.Id;
    ...
    try {
        ...
        dbConn.connect().then(function () {
            ...
            request.execute("Assessment_CreateOrUpdate").then(function (results) {
                console.log(results);
...
router.post('/delAssessment', function (req, res) {
    let Id = req.body.Id;
    try {
        if (Id == "") throw "Id is empty";
        ...
        dbConn.connect().then(function () {
            ...
            request.execute("Assessment_delete").then(function (results) {
                console.log(results);
