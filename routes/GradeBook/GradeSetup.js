...
router.post('/getGradeSetups', function (req, res) {
...
// 	"Id":"1"
// }
router.post('/getGradeSetup', function (req, res) {
    let Id = req.body.Id;
    try {
...
*/
router.post('/setGradeSetup', function (req, res) {
    let Id = req.body.Id;
    let Description = req.body.Description;
    let Type = req.body.Type;
    let PercentageFrom = req.body.PercentageFrom;
    let IPercentageTod = req.body.PercentageTo;
    ...
    try {
        ...
        if (IPercentageTod == "") throw "IPercentageTod is empty";
        ...
        dbConn.connect().then(function () {
            ...
            request.input('IPercentageTod', parseInt(IPercentageTod, 10));
            request.input('SubjectId', parseInt(SubjectId, 10));

            request.execute("RemarkSetup_CreateOrUpdate").then(function (results) {
                console.log(results);
...
router.post('/delGradeSetup', function (req, res) {
    let Id = req.body.Id;
    try {
        if (Id == "") throw "Id is empty";
