...
router.post('/getclasses', function (req, res) {
    ...
    try {
        ...
        dbConn.connect().then(function () {
            ...
            request.execute("ClassSelectAll").then(function (results) {
                console.log(results);
...
router.post('/getclass', function (req, res) {
    ...
    try {
        ...
        dbConn.connect().then(function () {
            ...
            request.execute("ClassSelectById").then(function (results) {
                console.log(results);
...
*/
router.post('/setclass', function (req, res) {
    let Id = req.body.Id;
    let Name = req.body.Name;
    let ReAdmissionRequired = req.body.ReAdmissionRequired;
    try {
        if (Id == "") throw "Id is empty";
        if (Name == "") throw "Name is empty";
        if (ReAdmissionRequired == "") throw "ReAdmissionRequired is empty";
        ...
        dbConn.connect().then(function () {
            ...
            request.input('ReAdmissionRequired', sql.VarChar, ReAdmissionRequired);


            request.execute("ClassCreateOrUpdate").then(function (results) {
                console.log(results);
...
router.post('/delClass', function (req, res) {
    ...
    try {
        ...
        dbConn.connect().then(function () {
            ...
            request.execute("Class_delete").then(function (results) {
                console.log(results);
...
router.post('/getsections', function (req, res) {
    ...
    try {
        ...
        dbConn.connect().then(function () {
            var request = new sql.Request(dbConn);
            request.execute("SectionSelectAll").then(function (results) {
                console.log(results);
...
router.post('/getsection', function (req, res) {
    ...
    try {
        ...
        dbConn.connect().then(function () {
            var request = new sql.Request(dbConn);
            request.input('Id', sql.Int, parseInt(Id, 10));
            request.execute("SectionSelectById").then(function (results) {
                console.log(results);
...
*/
router.post('/setsection', function (req, res) {
    let Id = req.body.Id;
    ...
    try {
        ...
        dbConn.connect().then(function () {
            ...
            request.execute("SectionCreateOrUpdate").then(function (results) {
                console.log(results);
...
router.post('/delSection', function (req, res) {
    let Id = req.body.Id;
    ...
    try {
        ...
        dbConn.connect().then(function () {
            ...
            request.execute("Section_delete").then(function (results) {
                console.log(results);
