...
router.post('/getEvents', function (req, res) {
    ...
    try {
        ...
        dbConn.connect().then(function () {
            ...
            request.execute("Events_selectAll").then(function (results) {
                console.log(results);
...
router.post('/getEvent', function (req, res) {
    ...
    try {
        ...
        dbConn.connect().then(function () {
            ...
            request.execute("Events_selectById").then(function (results) {
                console.log(results);
...
*/
router.post('/setEvent', function (req, res) {
    let Id = req.body.Id;
    ...
    try {
        ...
        if (FromDate == "") throw "FromDate is empty";
        if (ToDate == "") throw "ToDate is empty";
        if (EventTypeId == "") throw "EventTypeId is empty";
        ...
        dbConn.connect().then(function () {
            ...
            request.input('EventTypeId', sql.Int, parseInt(EventTypeId, 10));
            request.input('InstitutionId', sql.Int, parseInt(InstitutionId, 10));

            request.execute("Events_CreateOrUpdate").then(function (results) {
                console.log(results);

                if (results.returnValue != 0) {
                    res.send({
                        success: false,
                        message: "Error while updating Events.",
                        results: results
                    });
                } else {
                    res.send({
...
router.post('/delEvent', function (req, res) {
    ...
    try {
        ...
        dbConn.connect().then(function () {
            ...
            request.execute("Events_delete").then(function (results) {
                console.log(results);
