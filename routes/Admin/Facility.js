...
router.post('/getfacilities', function (req, res) {
    ...
    try {
        ...
        dbConn.connect().then(function () {
            ...
            request.execute("Facility_selectAll").then(function (results) {
                console.log(results);
                ...
                if (results.recordset === [] || results.recordset.length === 0 || results.recordset === undefined
                    ...
                    res.send({
                        success: false,
                        message: "Facility details not found"
                    });
                } else {
                    res.send({
                        success: true,
...
router.post('/getfacility', function (req, res) {
    ...
    try {
        ...
        dbConn.connect().then(function () {
            ...
            request.execute("Facility_selectById").then(function (results) {
                console.log(results);
...
*/
router.post('/setfacility', function (req, res) {
    let Id = req.body.Id;
    ...
    try {
        ...
        dbConn.connect().then(function () {
            ...
            request.execute("Facility_CreateOrUpdate").then(function (results) {
                console.log(results);
