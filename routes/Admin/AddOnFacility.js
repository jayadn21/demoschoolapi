...
router.post('/getAddOnFacilities', function (req, res) {
    ...
    try {
        ...
        dbConn.connect().then(function () {
            ...
            request.execute("AddOnFacility_selectAll").then(function (results) {
                console.log(results);
                ...
                if (results.recordset === [] || results.recordset.length === 0 || results.recordset === undefined
                    ...
                    res.send({
                        success: false,
                        message: "AddOnFacility details not found"
                    });
                } else {
                    res.send({
                        success: true,
...
// 	"Id":"1"
// }
router.post('/getAddOnFacility', function (req, res) {
    let Id = req.body.Id;
    try {
        ...
        dbConn.connect().then(function () {
            ...
            request.execute("AddOnFacility_selectById").then(function (results) {
                console.log(results);
