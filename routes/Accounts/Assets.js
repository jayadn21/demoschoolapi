...
router.post('/getassets', function (req, res) {

    try {
        var dbConn = new sql.ConnectionPool(localconfig);
        dbConn.connect().then(function () {
            var request = new sql.Request(dbConn);
            request.execute("Asset_selectAll").then(function (results) {
                console.log(results);
...
router.post('/getasset', function (req, res) {
    ...
    try {
        ...
        dbConn.connect().then(function () {
            ...
            request.execute("Asset_selectById").then(function (results) {
                console.log(results);
...
*/
router.post('/setasset', function (req, res) {
    let Id = req.body.Id;
    ...
    try {
        ...
        dbConn.connect().then(function () {
            ...
            request.execute("Asset_CreateOrUpdate").then(function (results) {
                console.log(results);
...
router.post('/delasset', function (req, res) {
    let Id = req.body.Id;
    try {
        if (Id == "") throw "Id is empty";
        ...
        dbConn.connect().then(function () {
            ...
            request.execute("Asset_delete").then(function (results) {
                console.log(results);
